...
#ifdef DUMMY_STS
#define MODEMDEVICE "/dev/ttyACM0" //!< STS端末を接続しているデバイス
#else
#define MODEMDEVICE "/dev/ttyACM0" //!< STS端末を接続しているデバイス
#endif
...
#define UDP_RECV_PORT 30000 //!< UDP受信ポート
#define UDP_RECV_IP   "127.0.0.1" //!< 受信IPアドレス
#define UDP_SEND_PORT 30001 //!< UDP送信先ポート
#define UDP_SEND_IP   "127.0.0.1" //!< 送信先IPアドレス
