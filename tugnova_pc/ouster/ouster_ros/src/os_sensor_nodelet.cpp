...
class OusterSensor : public OusterClientBase {
   ...
   private:
    ...
    void start_connection_loop() {
        ...
        ouster_state_pub = nh.advertise<std_msgs::Int16>("ouster_state", 1);
    ...
    void connection_loop(sensor::client& cli, const sensor::sensor_info& info) {
        ...
        // debug code
        std_msgs::Int16 ouster_state_msg;
        ouster_state_msg.data = state;
        ouster_state_pub.publish(ouster_state_msg);
        // end code
   ...
   private:
    ...
    ros::Publisher ouster_state_pub;
